...
{
    public class HospitalInforService : IHospitalInfo
    {
        private IUnitOfWork _unitOfWork;

        public HospitalInforService(IUnitOfWork unitOfWork)
        {
        ...
        public PagedResult<HospitalInfoViewModel> GetAll(int pageNumber, int pageSize)
        {
            ...
            return result;
            //var HospitalViewInfoModel = new HospitalInfoViewModel();
        }
        ...
        {
            var model = new HospitalInfoViewModel().ConvertViewModels(hospitalInfo);
